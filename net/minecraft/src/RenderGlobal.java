    ...
    public void renderEntities(Vec3 par1Vec3, ICamera par2ICamera, float par3)
    {
        ...
        else
        {
            ...
            for (var6 = 0; var6 < this.tileEntities.size(); ++var6)
            {
                ...
                if (var8.getClass() == TileEntitySign.class && !Config.zoomMode)
                {
                    EntityClientPlayerMP var9 = this.mc.thePlayer;
                    double var10 = var8.getDistanceFrom(var9.posX, var9.posY, var9.posZ);

                    if (var10 > 256.0D)
                    {
                        FontRenderer var12 = TileEntityRenderer.instance.getFontRenderer();
                        var12.enabled = false;
